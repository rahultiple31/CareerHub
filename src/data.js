export const jobs = [
  ...
  { id: 3, title: "AI Resume Matching Engineer", company: "TalentWorks AI", location: "Pune", experience: "3-5", salary: 30, skills: ["Python", "NLP", "PostgreSQL", "Search"], remote: true, match: 89, status: "Recommended" },
...
export const projects = [
  ...
  { id: 104, title: "Professional Feed and Referral Network", owner: "ReferralStack", budget: 22000, duration: "medium", skills: ["React", "PostgreSQL", "Kafka", "Moderation"], status: "Open for bidding" }
];
